...
const (
    //test
    AnkrContractAddressTest = "0x38A03b35a6662D35B226879E57d499eE26A6D4B5"
    prod
...
var contractAddreses =map[string]string{"ANKR":AnkrContractAddress,"ANKR-T":AnkrContractAddressTest}
