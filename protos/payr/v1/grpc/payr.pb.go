...
func init() {
	...
	proto.RegisterType((*GenerateAddressRequest)(nil), "payr.GenerateAddressRequest")
	proto.RegisterType((*GenerateAddressResponse)(nil), "payr.GenerateAddressResponse")
}
...
var fileDescriptor_91f59d6d1c7771cd = []byte{
	...
	,
}
...
func (c *payrClient) CreateAddress(ctx context.Context, in *GenerateAddressRequest, opts ...grpc.CallOption) (*GenerateAddressResponse, error) {
	out := new(GenerateAddressResponse)
	err := c.cc.Invoke(ctx, "/payr.Payr/CreateAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedPayrServer) CreateAddress(ctx context.Context, req *GenerateAddressRequest) (*GenerateAddressResponse, error) {
...
func _Payr_CreateAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PayrServer).CreateAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payr.Payr/CreateAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayrServer).CreateAddress(ctx, req.(*GenerateAddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Payr_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Payr_CreateAddress_Handler,
		},
	},
