...
func request_UserMgr_ConfirmPhoneRegistration_0(ctx context.Context, marshaler runtime.Marshaler, client UserMgrClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ConfirmPhoneRegistrationRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ConfirmPhoneRegistration(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_UserMgr_ConfirmPhoneRegistration_0(ctx context.Context, marshaler runtime.Marshaler, server UserMgrServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ConfirmPhoneRegistrationRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ConfirmPhoneRegistration(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterUserMgrHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserMgrServer) error {
	...
	mux.Handle("POST", pattern_UserMgr_ConfirmPhoneRegistration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_UserMgr_ConfirmPhoneRegistration_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_UserMgr_ConfirmPhoneRegistration_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUserMgrHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserMgrClient) error {
	...
	mux.Handle("POST", pattern_UserMgr_ConfirmPhoneRegistration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UserMgr_ConfirmPhoneRegistration_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_UserMgr_ConfirmPhoneRegistration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"confirm_phone_registratoin"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_UserMgr_ConfirmPhoneRegistration_0 = runtime.ForwardResponseMessage
