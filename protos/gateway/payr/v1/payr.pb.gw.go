...
var (
	...
	pattern_Payr_ListPlan_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"plans", "list"}, ""))

	pattern_Payr_ListSubs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"subs", "list"}, ""))

	pattern_Payr_PaymentHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"payment", "history"}, ""))
